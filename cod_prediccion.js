...
const categories = { 
  ...
  const enhancedKeywords = {
    ...
    deporte: ['partidos','Colombia','mundial','eliminatorias','selección','deporte', 'fútbol', 'baloncesto', 'correr', 'entrenamiento', 'ejercicio', 'equipo', 'competencia', 'salud física', 'atletismo', 'partido', 'juego', 'gimnasio', 'natación', 'ciclismo', 'victoria', 'derrota', 'energía', 'rendimiento', 'yoga', 'lucha'],
